...
De anonimizer als CLI: documenten in batch anonimiseren, met hergebruik van eerdere keuzes.

Status: in gebruik. Draait en wordt gebruikt; installatie via pip.
...
Power users die regelmatig documenten anonimiseren.
